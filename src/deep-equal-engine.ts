...
export class DeepEqualEngine {
    ...
    if (!comparator) {
		...
		if(comparator instanceof PrimitiveComparator) {
			...
			if (a && typeof a === 'object' && b && typeof b === 'object') {
				return comparator.compare(a as Record<string, unknown>, b as Record<string, unknown>, this);
			}
			return false;
		}
  }
  ...
  findComparator(value: unknown): ComparatorType | undefined {
    return this.comparators.find((comparator : ComparatorType) :boolean => comparator.canHandle(value));
  }
}

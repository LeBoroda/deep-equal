...
describe('Primitive values comparator test', () => {
  ...
  it('should handle bigint values', () => {
    expect(primComparator.canHandle(BigInt(Number.MAX_SAFE_INTEGER))).toBeTruthy();
  });
  ...
  it('should compare bigints correctly', () => {
    expect(primComparator.compare(BigInt(Number.MAX_SAFE_INTEGER), BigInt(Number.MAX_SAFE_INTEGER))).toBeTruthy();
